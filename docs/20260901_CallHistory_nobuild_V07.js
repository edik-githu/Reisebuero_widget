/*
 * Call-History Widget  |  Version V07 (no-build)  |  20260901
...
(function () {
  ...
  var STYLE =
    ...
    ":host([darkmode]) th,:host([darkmode]) td{border-bottom-color:#333}" +
    "thead{background:#f2f2f2}:host([darkmode]) thead{background:#2a2a2a}" +
    "thead th{font-size:.72rem;text-transform:uppercase;letter-spacing:.02em;color:#666}" +
    "tbody tr:nth-child(even){background:#fafafa}:host([darkmode]) tbody tr:nth-child(even){background:#262626}" +
    "tbody tr:hover{background:#e6f7ff}:host([darkmode]) tbody tr:hover{background:#333}" +
